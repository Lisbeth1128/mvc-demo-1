...
var $button1 = (0, _jquery.default)('#addOne');
var $button2 = (0, _jquery.default)('#minusOne');
var $button3 = (0, _jquery.default)('#multiTwo');
var $button4 = (0, _jquery.default)('#divideTwo');
var n = localStorage.getItem("n");
var $app1Number = (0, _jquery.default)('#app1Number');
$app1Number.text(n || 100);
$button1.on('click', function () {
  var n = parseInt($app1Number.text());
  n += 1;
